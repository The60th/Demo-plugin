...
public final class utilityStrings {
    public final static String worldciv = ChatColor.DARK_GRAY + "[" + ChatColor.GOLD + "World-Civ" + ChatColor.DARK_GRAY + "]";
    public final static String bars = ChatColor.GOLD + "▬▬▬" + ChatColor.DARK_GRAY + "▬▬▬";
